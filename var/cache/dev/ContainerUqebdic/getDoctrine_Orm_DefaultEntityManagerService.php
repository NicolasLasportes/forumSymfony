...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CommentaryRepository' => function () {
    return ($this->privates['App\Repository\CommentaryRepository'] ?? $this->load('getCommentaryRepositoryService.php'));
}, 'App\\Repository\\DiscussionRepository' => function () {
    return ($this->privates['App\Repository\DiscussionRepository'] ?? $this->load('getDiscussionRepositoryService.php'));
}))));
