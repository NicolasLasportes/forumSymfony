...
// Returns the private 'App\Repository\CommentaryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CommentaryRepository.php';

return $this->privates['App\Repository\CommentaryRepository'] = new \App\Repository\CommentaryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
